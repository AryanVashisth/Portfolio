        ...
        <div className="space-y-10 sm:space-y-12">
          {EXPERIENCE.map((exp, index) => (
            <motion.div
              ...
              className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 pb-10 sm:pb-12 border-b border-white/5 last:border-0 group"
            >
              <div className="md:col-span-1">
                <div className="sticky top-24">
                  ...
                  <h4 className="text-lg sm:text-xl font-bold uppercase tracking-tight group-hover:text-brand-primary transition-colors\">
                    {exp.company}
                  </h4>
                </div>
              </div>
              ...
              <div className="md:col-span-3">
                ...
                <ul className="space-y-3 sm:space-y-4">
                  {exp.description.map((item, i) => (
                    <li key={i} className="flex gap-4 text-white/60 leading-relaxed text-sm\">
                      <span className="text-brand-primary font-mono mt-1 flex-shrink-0\">/</span>
                      {item}
                    </li>
                  ))}
                </ul>
